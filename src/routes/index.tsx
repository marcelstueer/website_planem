...
function HomePage() { return <>
  ...
  <section className="py-20 md:py-28"><div className="site-container"><SectionHeading eyebrow="Kompetenz im Verbund" title="Zwei Perspektiven. Ein tragfähiges Konzept." text="Regulatorische Anforderungen werden zu Lösungen, die individuell fundiert, wirtschaftlich, ökologisch und im Alltag sinnvoll sind." />
    <div className="grid gap-5 md:grid-cols-2">
      <article className="group overflow-hidden bg-card"><div className="aspect-[7/5] overflow-hidden"><img src={mobilityImage} alt="Mobilitätsstation mit Radverkehr, ÖPNV und Ladeinfrastruktur" loading="lazy" width={1408} height={1008} className="h-full w-full object-cover transition-transform duration-500 group-hover:scale-[1.02]" /></div><div className="border border-t-0 border-border p-7 md:p-9"><CarFront className="mb-7 size-7 text-primary"/><h3 className="text-3xl font-light">Zukunftsgerechte Mobilität</h3><p className="mt-4 leading-7 text-muted-foreground">Bedarfsgerechte Konzepte für eine individuelle Verkehrswende von Betrieben, Liegenschaften und Quartieren. Durch Fördermittel, E-Mobilität oder Stellplatzreduzierung mehr Lebensqualität für die Menschen und Wertsteigerung ihrer Immobilie.</p><Link to="/leistungen" className="mt-7 inline-flex items-center gap-2 text-sm font-semibold text-primary">Mehr erfahren <ArrowRight className="size-4"/></Link></div></article>
      <article className="group overflow-hidden bg-card"><div className="aspect-[7/5] overflow-hidden"><img src={energyImage} alt="Energieeffizientes Nichtwohngebäude in der Planung" loading="lazy" width={1408} height={1008} className="h-full w-full object-cover transition-transform duration-500 group-hover:scale-[1.02]" /></div><div className="border border-t-0 border-border p-7 md:p-9"><Building2 className="mb-7 size-7 text-brand-blue"/><h3 className="text-3xl font-light">Energieeffizienz und Kostenreduzierung</h3><p className="mt-4 leading-7 text-muted-foreground">Energieberatung für Nichtwohngebäude, Prozesse, Audits und Managementsysteme – mit passender Fördermittelstrategie ganz individuell auf Ihre Anforderungen zugeschnitten.</p><Link to="/leistungen" className="mt-7 inline-flex items-center gap-2 text-sm font-semibold text-primary">Mehr erfahren <ArrowRight className="size-4"/></Link></div></article>
    </div><p className="mt-3 text-right text-xs text-muted-foreground">Bildmaterial KI-generiert</p>
  </div></section>
  <section className="bg-secondary py-20 md:py-28"><div className="site-container grid gap-12 md:grid-cols-[1fr_1.25fr]"><div><p className="eyebrow">Warum planem</p><h2 className="mt-5 text-4xl font-light leading-tight md:text-6xl">Regional verankert.<br/>International inspiriert.</h2></div><div className="space-y-7 text-lg font-light leading-8 text-muted-foreground"><p>Internationale Erfahrungen aus den Niederlanden und Japan fließen in Lösungen ein, die auf den hiesigen Markt und seine Anforderungen zugeschnitten sind.</p><div className="grid gap-4 border-t border-border pt-7 sm:grid-cols-2">{["BAFA- und KfW-zertifiziert seit 2016","IHK-zertifizierter Mobilitätsmanager","Master of Engineering","Münster und die Region"].map((item)=><div key={item} className="flex gap-3 text-sm font-medium text-foreground"><CheckCircle2 className="mt-0.5 size-5 shrink-0 text-primary"/>{item}</div>)}</div><Button asChild variant="outline"><Link to="/ueber-planem">Mehr über planem <ArrowRight /></Link></Button></div></div></section>
   <section className="py-20 md:py-24"><div className="site-container flex flex-col justify-between gap-8 border-y border-border py-12 md:flex-row md:items-center"><div><p className="eyebrow">Ihr Vorhaben</p><h2 className="mt-3 text-3xl font-light md:text-5xl">Lassen Sie uns rechtzeitig ins Gespräch kommen, um das maximale für Ihr Vorhaben herauszuholen.</h2></div><Button asChild size="lg"><Link to="/kontakt">Anfrage starten <ArrowRight /></Link></Button></div></section>
</>; }
