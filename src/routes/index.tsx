...
function HomePage() { return <>
  ...
  <section className="py-20 md:py-28"><div className="site-container"><SectionHeading eyebrow="Kompetenz im Verbund" title="Zwei Perspektiven. Ein tragfähiges Konzept." text="Regulatorische Anforderungen werden zu Lösungen, die individuell fundiert, wirtschaftlich, ökologisch und im Alltag sinnvoll sind." />
    <div className="grid gap-5 md:grid-cols-2">
      <article className="group overflow-hidden bg-card"><div className="aspect-[7/5] overflow-hidden"><img src={mobilityImage} alt="Mobilitätsstation mit Radverkehr, ÖPNV und Ladeinfrastruktur" loading="lazy" width={1408} height={1008} className="h-full w-full object-cover transition-transform duration-500 group-hover:scale-[1.02]" /></div><div className="border border-t-0 border-border p-7 md:p-9"><CarFront className="mb-7 size-7 text-primary"/><h3 className="text-3xl font-light">Mobilität</h3><p className="mt-4 leading-7 text-muted-foreground">Bedarfsgerechte Konzepte für eine individuelle Verkehrswende von Betrieben, Liegenschaften und Quartieren. Durch Fördermittel, E-Mobilität oder Stellplatzreduzierung mehr Lebensqualität für die Menschen und Wertsteigerung ihrer Immobilie.</p><Link to="/leistungen" className="mt-7 inline-flex items-center gap-2 text-sm font-semibold text-primary">Mehr erfahren <ArrowRight className="size-4"/></Link></div></article>
      <article className="group overflow-hidden bg-card"><div className="aspect-[7/5] overflow-hidden"><img src={energyImage} alt="Energieeffizientes Nichtwohngebäude in der Planung" loading="lazy" width={1408} height={1008} className="h-full w-full object-cover transition-transform duration-500 group-hover:scale-[1.02]" /></div><div className="border border-t-0 border-border p-7 md:p-9"><Building2 className="mb-7 size-7 text-brand-blue"/><h3 className="text-3xl font-light">Energieeffizienz</h3><p className="mt-4 leading-7 text-muted-foreground">Energieberatung für Nichtwohngebäude, Prozesse, Audits und Managementsysteme – mit passender Fördermittelstrategie.</p><Link to="/leistungen" className="mt-7 inline-flex items-center gap-2 text-sm font-semibold text-primary">Mehr erfahren <ArrowRight className="size-4"/></Link></div></article>
  ...
  <section className="py-20 md:py-24"><div className="site-container flex flex-col justify-between gap-8 border-y border-border py-12 md:flex-row md:items-center"><div><p className="eyebrow">Ihr Vorhaben</p><h2 className="mt-3 text-3xl font-light md:text-5xl">Lassen Sie uns früh ins Gespräch kommen.</h2></div><Button asChild size="lg"><Link to="/kontakt">Anfrage starten <ArrowRight /></Link></Button></div></section>
</>; }
