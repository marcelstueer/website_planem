...
function HomePage() { const { text } = useSiteTexts(); return <>
  <section className="relative min-h-[calc(100svh-5rem)] overflow-hidden bg-ink text-ink-foreground">
    <SiteImage imageKey="home.hero" fallback={heroImage} alt="Modernes Quartier mit Radweg und energieeffizienten Gebäuden" className="absolute inset-0 h-full w-full object-cover" width={1600} height={1008} fetchPriority="high" />
    ...
    <div className="site-container relative flex min-h-[calc(100svh-5rem)] flex-col justify-between py-14 md:py-20">
      <div className="reveal max-w-4xl"><p className="eyebrow !text-brand-light">{text("home.hero.eyebrow", "Ingenieurbüro aus Münster")}</p><h1 className="mt-5 text-5xl font-extralight leading-[1.03] md:text-7xl lg:text-8xl">{text("home.hero.title", "Gebäude und Mobilität.")}<br/><span className="text-brand-light">{text("home.hero.title.accent", "Zusammen gedacht.")}</span></h1><p className="mt-7 max-w-2xl text-lg font-light leading-8 text-ink-muted md:text-xl">{text("home.hero.text", "Unabhängige Planung und Beratung für zukunftsfähige Gebäude, Betriebe und Quartiere.")}</p><div className="mt-9 flex flex-wrap gap-3"><Button asChild size="lg"><Link to="/leistungen">Leistungen entdecken <ArrowRight /></Link></Button><Button asChild size="lg" variant="outline" className="border-ink-muted bg-transparent text-ink-foreground hover:bg-ink-foreground hover:text-ink"><Link to="/kontakt">Gespräch vereinbaren</Link></Button></div></div>
   ...
   <section className="py-20 md:py-28"><div className="site-container"><SectionHeading eyebrow="Kompetenz im Verbund" title="Ein tragfähiges Konzept. Mehrere Blickwinkel. " text="Regulatorische Anforderungen werden zu Lösungen, die individuell fundiert, wirtschaftlich, ökologisch und im Alltag sinnvoll sind." />
    <div className="grid gap-5 md:grid-cols-2">
       <article className="group overflow-hidden bg-card"><div className="aspect-[7/5] overflow-hidden"><SiteImage imageKey="home.mobility" fallback={mobilityImage} alt="Modernes Quartier mit attraktiver Rad- und Fußverkehrsanbindung" loading="lazy" width={1400} height={1000} className="h-full w-full object-cover transition-transform duration-500 group-hover:scale-[1.02]" /></div><div className="border border-t-0 border-border p-7 md:p-9"><CarFront className="mb-7 size-7 text-primary"/><h3 className="text-3xl font-light">Mobilität: Zukunftsgerecht</h3><p className="mt-4 leading-7 text-muted-foreground">Effektive Konzepte für eine Verkehrswende von Betrieben, Liegenschaften und Quartieren. Durch Fördermittel, E-Mobilität oder Stellplatzreduzierung mehr Lebensqualität für die Menschen vor Ort und Wertsteigerung im Immobilienquartier.</p><Link to="/leistungen" className="mt-7 inline-flex items-center gap-2 text-sm font-semibold text-primary">Mehr erfahren <ArrowRight className="size-4"/></Link><p className="mt-6 text-[11px] uppercase tracking-[.16em] text-muted-foreground/60">Bildmaterial: KI-generiert</p></div></article>
       <article className="group overflow-hidden bg-card"><div className="aspect-[7/5] overflow-hidden"><SiteImage imageKey="home.energy" fallback={energyImage} alt="Energieeffizientes Nichtwohngebäude mit moderner Architektur" loading="lazy" width={1400} height={1000} className="h-full w-full object-cover transition-transform duration-500 group-hover:scale-[1.02]" /></div><div className="border border-t-0 border-border p-7 md:p-9"><Building2 className="mb-7 size-7 text-brand-blue"/><h3 className="text-3xl font-light">Energieeffizienz = Kostenreduzierung</h3><p className="mt-4 leading-7 text-muted-foreground">Energie- und Fördermittelberatung für Nichtwohngebäude, Prozesse, Audits und Managementsysteme – mit passender Strategie ganz individuell auf Ihre Anforderungen zugeschnitten.</p><Link to="/leistungen" className="mt-7 inline-flex items-center gap-2 text-sm font-semibold text-primary">Mehr erfahren <ArrowRight className="size-4"/></Link><p className="mt-6 text-[11px] uppercase tracking-[.16em] text-muted-foreground/60">Bildmaterial: KI-generiert</p></div></article>
    </div>
  </div></section>
