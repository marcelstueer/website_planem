...
function ServicesPage() { return <><section className="bg-secondary py-20 md:py-28"><div className="site-container grid gap-8 md:grid-cols-[1fr_2fr]"><p className="eyebrow">Leistungen</p><div><h1 className="max-w-4xl text-5xl font-extralight leading-[1.05] md:text-7xl">Einfache und machbare Konzepte, die Anforderungen verbindet.</h1><p className="mt-7 max-w-2xl text-lg leading-8 text-muted-foreground">Mobilität und Energie werden nicht isoliert betrachtet, sondern als zusammenhängende Bausteine eines zukunftsfähigen Standorts.</p></div></div></section><ServiceBlock number="01 / Mobilität" title="Weniger Stellplätze. Mehr Möglichkeiten." intro="Von der Bestandsanalyse bis zum genehmigungsfähigen Konzept entstehen Lösungen, die Verhalten, Infrastruktur und regulatorische Anforderungen zusammenführen." image={mobilityImage.url} imageKey="home.mobility" imageAlt="Baustellensituation mit markierter Radverkehrsführung in Münster" items={mobility}/><div className="bg-secondary"><ServiceBlock number="02 / Energie" title="Effizienz, die sich rechnet." intro="Technische Analyse, verständliche Entscheidungsgrundlagen und die passende Förderung schaffen einen belastbaren Weg zu geringeren Verbräuchen und Emissionen." image={energyImage.url} imageKey="home.energy" imageAlt="Windenergieanlage über einem Feld im Münsterland" items={energy}/></div><section className="bg-ink py-16 text-ink-foreground"><div className="site-container flex flex-col justify-between gap-7 md:flex-row md:items-center"><h2 className="max-w-2xl text-3xl font-light md:text-5xl">Welche Aufgabe dürfen wir gemeinsam lösen?</h2><Button asChild size="lg"><Link to="/kontakt">Projekt besprechen <ArrowRight/></Link></Button></div></section><SeoSection /></>; }
